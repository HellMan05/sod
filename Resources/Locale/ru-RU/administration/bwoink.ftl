...
bwoink-system-introductory-message =
    Пожалуйста, подробно опишите проблему, с которой вы столкнулись. Имейте в виду, что администратор, решающий вашу проблему, не знает о случившемся из первых рук.
    О любых ошибках и других проблемах следует сообщать нам в Discord в специальный канал.
