...
ent-ComputerCargoOrders = консоль заказов снабжения
    .desc = Используется отделом снабжения, для оформления запросов и одобрения заказов.
ent-ComputerCargoOrdersEngineering = консоль заказов инженерии
    .desc = Используется инженерным отделом, для оформления запросов и одобрения заказов.
ent-ComputerCargoOrdersMedical = консоль заказов медицинского отдела
    .desc = Используется медицинским отделом, для оформления запросов и одобрения заказов.
ent-ComputerCargoOrdersScience = консоль заказов рнд
    .desc = Используется научным отделом, для оформления запросов и одобрения заказов.
ent-ComputerCargoOrdersSecurity = консоль заказов службы безопасности
    .desc = Используется отделом службы безопасности, для оформления запросов и одобрения заказов.
ent-ComputerCargoOrdersService = консоль заказов сервиса
    .desc = Используется сервисным отделом, для оформления запросов и одобрения заказов.
...
ent-ComputerSalvageJobBoard = консоль утилизаторских работ
