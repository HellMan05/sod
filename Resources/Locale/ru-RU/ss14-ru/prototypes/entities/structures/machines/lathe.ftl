...
ent-MachineMaterialSilo = силосное хранилище
    .desc = Передовая машина, использующая блюспейс-технологии для передачи материалов между устройствами в радиусе действия.
