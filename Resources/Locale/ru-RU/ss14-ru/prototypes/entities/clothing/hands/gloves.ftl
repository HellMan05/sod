...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные кастеты из пластали. Удары становятся намного сильнее.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Кастеты из латуни. Ничего лишнего — только проверенная мощь.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты КМ'а
    .desc = Кастеты из 24-каратного золота, усиленные пласталью, с логотипом NanoTrasen. Истинный символ могущества Квартирмейстера
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Кастеты из пластитана с кроваво-красной буквой S. Настоящий мужик ими запросто отправит к праотцам.
ent-ClothingHandsKnuckleDustersStun = шок-кастеты
    .desc = Пара кастетов, совмещённых с дубинкой-шокером. Теперь разбираться с мелкими воришками стало куда проще.
ent-ClothingHandsKnuckleBoneCrushers = крушители костей
    .desc = Благословлены богами, чтобы сокрушать всех непокорных.
    .suffix = Адмемы
