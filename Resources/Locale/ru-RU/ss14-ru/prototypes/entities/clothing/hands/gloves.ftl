...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные пласталевые кастеты. Удары становятся намного сильнее.
...
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Пластитановые кастеты с кроваво-красной буквой S. Настоящий мужик ими запросто отправит к праотцам.
