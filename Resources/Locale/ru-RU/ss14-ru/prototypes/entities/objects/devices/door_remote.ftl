...
ent-DoorRemoteEngineering = пульт от шлюзов инженерного отдела
    .desc = { ent-DoorRemoteDefault.desc }
ent-DoorRemoteCustom = универсальный пульт от шлюзов
    .desc = Гаджет, который может открывать и закрывать шлюзы дистанционно. Эта продвинутая версия не имеет встроенного доступа, вместо этого использует доступ ID-карты пользователя.
