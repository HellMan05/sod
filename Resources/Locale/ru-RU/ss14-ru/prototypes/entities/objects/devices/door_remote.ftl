...
ent-DoorRemoteCustom = универсальный пульт от шлюзов
    .desc = Гаджет, который может открывать и закрывать шлюзы дистанционно. Эта продвинутая версия не имеет встроенного доступа, вместо этого использует доступ пользователя.
