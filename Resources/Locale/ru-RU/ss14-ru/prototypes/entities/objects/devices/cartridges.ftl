...
ent-GasAnalyzerCartridge = картридж АтмоАлерт
    .desc = Программа контроля окружающей среды, которая отображает текущий уровень газов.
ent-NanoTaskCartridge = картридж НаноТаск
    .desc = Программа для ведения списка задач.
ent-PlantAnalyzerCartridge = картридж АгроСкан
    .desc = Программа, предоставляющая инструменты для диагностики растительности.
