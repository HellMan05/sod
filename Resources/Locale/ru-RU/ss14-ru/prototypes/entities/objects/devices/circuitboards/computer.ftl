...
ent-CargoRequestComputerCircuitboard = консоль заказов снабжения (консольная плата)
    .desc = Консольная плата для консоли заказов снабжения.
...
ent-CargoRequestScienceComputerCircuitboard = консоль заказов рнд (консольная плата)
    .desc = Консольная плата для консоли заказов рнд.
ent-CargoRequestServiceComputerCircuitboard = консоль заказов сервиса (консольная плата)
    .desc = Консольная плата для консоли заказов сервиса.
ent-CargoRequestEngineeringComputerCircuitboard = консоль заказов инженерии (консольная плата)
    .desc = Консольная плата для консоли заказов инженерии.
...
ent-SalvageJobBoardComputerCircuitboard = консоль утилизаторских работ (консольная плата)
    .desc = Консольная плата для консоли утилизаторских работ.
