...
ent-CrateMaterialGold = ящик золота
    .desc = 30 единиц золота.
ent-CrateMaterialSilver = ящик серебра
    .desc = 30 единиц серебра.
...
ent-CrateMaterialBasicResource = ящик стандартных материалов
    .desc = Содержит 30 листов стали, пластика и стекла.
ent-CrateMaterialSilo = ящик силосного хранилища
    .desc = Комплект для сборки силосного хранилища. Включает все необходимые компоненты.
ent-CrateMaterialRandom = излишки материалов
    .desc = Откуда-то взятые излишки материалов.
ent-CrateMaterialRandom = излишки материалов
    .desc = Откуда-то взятые излишки материалов.
