...
ent-CrateFoodGetMore = ящик снеков Getmore
    .desc = Фирменные снеки и ингредиенты для выпечки Getmore — для вдохновения шеф-повара! Всё самое нужное — без опустошения автоматов на станции.
