...
implanter-draw-failed-catastrophically = Имплантер ничего не находит и катастрофически выходит из строя, перенаправляя генетический материал в руку {$user}! Пошёл ты!!
implanter-component-implant-already = { $target } уже имеет { $implant }!

## UI
implanter-set-draw-verb = Настройка модели импланта
implanter-set-draw-window = Настройка модели импланта
implanter-set-draw-info = Выберите тип импланта который будет извлечён:
...
scramble-on-trigger-popup = Вы превратились в { $identity }

## Implant Messages

rattle-on-trigger-dead-message = Зафиксирована смерть { $user } { $position }.
