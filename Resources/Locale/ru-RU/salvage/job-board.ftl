...
bounty-description-remains = Нам нужно, чтобы вы достали несколько образцов сердца легиона. Имейте в виду, что легион может бесконечно призывать черепа, если ядро не будет уничтожено. Смотрите чтобы они не превзошли вас количеством.
