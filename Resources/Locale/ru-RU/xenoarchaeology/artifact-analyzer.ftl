analysis-console-menu-title = Многофункциональная аналитическая консоль Mark 3
...
analysis-console-info-effect-value = [font="Monospace" size=11][color=gray]{ $state ->
    [true] {$info}
    *[false] Разблокируйте узлы для получения данных
}[/color][/font]
...
analysis-console-extract-none = [font="Monospace" size=11][color=orange] В разблокированных узлах больше нет очков для получения [/color][/font]
analysis-console-extract-sum = [font="Monospace" size=11][color=orange]Общее изучение: {$value}[/color][/font]
