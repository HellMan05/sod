...
### Description hints
xenoarch-trigger-examine-wrenching = Какая-то деталь открутилась и вращается.
xenoarch-trigger-examine-prying = Из поверхности выдвигается панель.
xenoarch-trigger-examine-screwing = На выступе видно небольшое углубление.
xenoarch-trigger-examine-pulsing = Диод выступает из поверхности артефакта.
xenoarch-trigger-examine-timer = Поверхность покрыта насечками и царапинами... Едва различимо число: [italic]{$time}[/italic]
