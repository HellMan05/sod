...
portable-generator-start-fail = Вы пытаетесь включить генератор, но он не заводится.
portable-generator-start-success = Вы пытаетесь включить генератор, и он оживает.
portable-generator-ui-title = Генератор.
